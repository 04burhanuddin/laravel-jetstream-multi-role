<div>
    <section class="container px-4 py-4 mx-auto mt-6 lg:px-8">
        <div x-data="{ activeTab: 'category' }">
            <ul class="flex flex-wrap gap-8 text-gray-400">
                <li>
                    <a @click.prevent="activeTab = 'category'" :class="{ 'button-active text-gray-800 font-medium border-b-2 border-blue-500 py-3': activeTab === 'category' }" href="#category" class="button">All Category</a>
                </li>
                <li>
                    <a @click.prevent="activeTab = 'new'" :class="{ 'button-active text-gray-800 font-medium border-b-2 border-blue-500 py-3': activeTab === 'new' }" href="#new" class=" button">New Category</a>
                </li>
            </ul>
            <div class="content">
                <div x-cloak x-show="activeTab === 'category'">
                    <div>
                                    ...
                                    <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            <thead class="bg-gray-50 dark:bg-gray-800">
                                                <tr>
                                                    <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Category ID</th>
                                                    <th scope="col" class="px-12 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Category name</th>
                                                ...
                                                @foreach ($categories as $cat)
                                                    <tr>
                                                        <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                            <h2 class="font-medium text-gray-800 dark:text-white ">{{ $cat->id }}</h2>
                                                        </td>
                                                        ...
                                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                            <img class="object-cover w-6 h-6 -mx-1 border-2 border-white rounded-full dark:border-gray-700 shrink-0"
                                                                src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80" alt="">
                                                        </td>
